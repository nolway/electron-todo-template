...
var incompleteTaskHolder=document.getElementById("list-unstyled");//ul of #list-unstyled
...
var createNewTaskElement=function(taskString){
	...
	editButton.innerText="Modifier";//innerText encodes special characters, HTML does not.
...
var taskIncomplete=function(){
    ...
    //Append the task list item to the #list-unstyled.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
